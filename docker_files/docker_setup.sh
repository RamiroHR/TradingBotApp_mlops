...
docker image build . -t ramirohr/tradingbot:1.1.0 -f docker_files/tradingbot_api/Dockerfile
...
## build image
docker image build . -t ramirohr/credentials_api:1.0.4 -f docker_files/users_credentials_api/Dockerfile
